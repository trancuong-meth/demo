...
<div class="col-8 offset-2 mt-3">
    <form name="myForm"
          ...
          method="POST"
          action="/demo_war_exploded/hoa-don/update?ma=${ hd.ma }">
        <div class="row">
            <div class="col-6">
                <label for="ma">Mã</label>
                <input type="text" id="ma" name="ma" class="form-control" value="${ hd.ma }" disabled/>
        ...
        <div class="row">
            <div class="col-6">
                ...
                <input type="text" id="diaChi" name="diaChi" class="form-control" value="${ hd.diaChi }"/>
                <span class="error-message" id="username-error2"></span>
            </div>
            <div class="col-6">
                <label for="ngayTao">Ngày tạo</label>
                <input type="text" id="ngayTao" name="ngayTao" class="form-control" value="${ hd.ngayTao }"/>
        ...
        <div class="row">
            <div class="col-6">
                ...
                <input type="text" id="ngayThanhToan" name="ngayThanhToan" class="form-control"
                       value="${ hd.ngayThanhToan }"/>
                <span class="error-message" id="username-error4"></span>
            </div>
            <div class="col-6">
                <label for="ngayShip">Ngày ship</label>
                <input type="text" id="ngayShip" name="ngayShip" class="form-control" value="${ hd.ngayShip }"/>
        ...
        <div class="row">
            <div class="col-12">
                ...
                <input type="text" id="ngayNhan" name="ngayNhan" class="form-control" value="${ hd.ngayNhan }"/>
                <span class="error-message" id="username-error6"></span>
            </div>
            <div class="col-12">
                <label for="sdt">SĐT</label>
                <input type="text" id="sdt" name="sdt" class="form-control" value="${ hd.ngayNhan }"/>
            ...
            <div class="col-12">
                ...
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="radio" name="tinhTrang" id="tinhTrang2"
                           value="Huỷ" ${ hd.tinhTrang == "2" ? "checked" : ""}/>
        ...
        <div class="row">
            <div class="col-6">
                <input type="submit" class="btn btn-primary" value="Sửa hoá đơn"/>
            </div>
            <div class="col-6"></div>
        </div>
    </form>
