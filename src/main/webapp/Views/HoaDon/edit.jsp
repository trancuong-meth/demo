...
<div class="col-8 offset-2 mt-3">
    <form name="myForm"
          ...
          method="POST"
          action="/demo_war_exploded/chuc-vu/update?ma=${ cv.ma }">
        ...
        <div class="row">
            ...
            <div class="col-6">
                ...
                <input type="text" id="ten" name="ten" class="form-control" value="${ cv.ten }"/>
        ...
        <div class="row">
            <div class="col-6">
                <input type="submit" class="btn btn-primary" value="Sửa chức vụ"/>
            </div>
            <div class="col-6"></div>
        </div>
    </form>
...
<script>
    function validateForm() {
        ...
        if (ten == "") {
            document.getElementById("username-error").innerHTML = "Vui lòng nhập tên chức vụ";
            flag = false;
        }
        return flag;
    }
