...
<div class="col-8 offset-2 mt-3">
    <form method="POST"
          ...
          action="/demo_war_exploded/mau-sac/update?ma=${ ms.ma }">
        <div class="row">
            <div class="col-6">
                <label>Mã</label>
            ...
            <div class="col-6">
                ...
                <input type="text" id="ten" name="ten" class="form-control" value="${ ms.ten }"/>
        ...
        <div class="row">
            <div class="col-6">
                <input type="submit" class="btn btn-primary" value="Sửa màu sắc"/>
            </div>
        </div>
    </form>
</div>
...
<script>
    function validateForm() {
        ...
        if (ten == "") {
            document.getElementById("username-error1").innerHTML = "Vui lòng nhập tên màu sắc";
            flag = false;
        } else {
